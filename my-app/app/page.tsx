    ...
    <div>
      ...
      <main>      
        ...
        <div className="flex flex-row justify-center">
          ...
          <article className="flex flex-row justify-between w-full h-full text-justify text-slate-500 bg-slate-100/90 dark:text-slate-300 dark:bg-slate-700/70 rounded-tl rounded-bl shadow-box mx-10 mb-40">
            ...
            <div className="w-4/5 h-auto flex flex-col justify-between p-4">
              ...
              <p className={`text-3xl text-slate-500 dark:text-slate-300 mt-4 mb-1 ${lavishlyFont.className}`}>
